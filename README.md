...
In addition, some alternatives to launching kubernetes clusters on bare-metal servers will be briefly introduced for Kubernetes clusters with metal-stack such as:
